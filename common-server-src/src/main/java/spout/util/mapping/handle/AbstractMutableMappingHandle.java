...
/**
 * An {@link AbstractMappingHandle} for a type {@link T} that can be mutated in-place as an instance of {@link MT}.
 */
public interface AbstractMutableMappingHandle<T, MT extends T> extends AbstractMappingHandle<T> {
